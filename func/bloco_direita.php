...
function bloco_direita_func( $atts ) {
	...
	$img_vinheta_600="https://institutoarkeos.com.br/wp-content/themes/mcd/img/logo-cinza.png";
	endif;
	...
	$html = ' <section class="section-services gauche">
    <div class="row">
            ...
            <div class="images-services-container 
                ...
                <div class="image-principale-container">
                    <div class="image-principale-wrapper">
                        <img width="900" height="600" src="'. $img_vinheta_900 .'" class="attachment-medium size-medium" alt="" srcset="'. $img_vinheta_900 .' 900w, '. $img_vinheta_1200 .' 1200w, '. $img_vinheta_768 .' 768w" sizes="(max-width: 900px) 100vw, 900px" /> 
                    </div>
                </div>
    ...
    add_shortcode('bloco_direita', 'bloco_direita_func'); 
